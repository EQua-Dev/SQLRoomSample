...
class SignUpFragment : Fragment(), CountryCodePicker.OnCountryChangeListener {
    ...
    private fun validateInput(){
        with(binding) {
            ...
            if (!Patterns.EMAIL_ADDRESS.matcher(mSignUpEmail).matches()) {
            ...
            if (mSignUpPassword.isEmpty() || mSignUpPassword.length < 6) {
            ...
            if (mSignUpConfirmPassword != mSignUpPassword) {
            ...
            if (this?.signUpPhoneNumber?.text.toString().isEmpty()){
